using System;
{
    ...
    que muestre la secuencia de números desde 1 hasta el numero ingresado por el usuario. ");
        ...
        if (Usu == 3)
        {
            //Crear un programa que pida al usuario un número. Si el numero ingresado es cero, mostrar un mensaje de error y terminar. En caso contrario que muestre la secuencia de números desde 1 hasta el numero ingresado por el usuario.
            int Num;
